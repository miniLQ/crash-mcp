...
class UnifiedSession:
    ...
    def start(self, timeout: int = 120, on_progress: Optional[Callable[[float, str], None]] = None):
        """Starts one or both analysis engines."""
        ...
        if self.enable_drgn and self.drgn_session is not None:
            try:
            ...
            self.drgn_start_error = "Drgn disabled for split dump sessions."
            report(90, "Drgn engine skipped for split dump session")
